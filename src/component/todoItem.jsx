  ...
  const updateTodoList = () => {
    ...
    dispatch(
      todoAction.updateTodo({
        editTask: enterEditTask,
        editCategory: categoryOption2,
        id: props.id,
      })
    );
      ...
      >
        {isEditing ? (
          <div style={{ display: "flex", flexDirection: "row", gap: 30 }}>
            <div>
              ...
              <input
                ...
                value={editValue1}
              />
              <button onClick={addEditCategory}>
              ...
              <select
                ...
                onChange={(e) => setCategoryOption2(e.target.value)}
              >
          ...
          <div style={{ display: "flex", flexDirection: "row", gap: 30 }}>
            ...
            <button onClick={() => !props.done && isEditingHandler(props.id)}>
              Edit
            </button>
          </div>
        )}
